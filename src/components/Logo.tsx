      ...
      >
        <svg viewBox="0 0 64 64" className="h-9 w-9" fill="none">
          <circle
            ...
            cy="32"
            r="30"
            className="stroke-gold-600 dark:stroke-gold-400"
            strokeWidth="1"
          />
          <text
            x="32"
            ...
            fontSize="32"
            className="fill-gold-600 dark:fill-gold-400"
            fontWeight="500"
          >
            A
          </text>
  ...
  return (
    ...
    >
      ...
      <span className="flex flex-col leading-none whitespace-nowrap">
        ...
        <span className="mt-1 text-[10px] uppercase tracking-widest2 text-ink-500 dark:text-cream/50">
