...
const SocialIcon = ({ name }: { name: string }) => {
  ...
  switch (name) {
    ...
    case "WhatsApp":
      return (
        <svg {...common}>
          <path d="M20.5 3.5A10.5 10.5 0 0 0 3.6 16.3L2 22l5.8-1.5A10.5 10.5 0 1 0 20.5 3.5z" />
          <path d="M8.2 7.5c.3 0 .6 0 .8.5l.9 2.1c.1.3 0 .5-.1.7l-.5.7c-.2.2-.3.5-.1.8a8 8 0 0 0 3.7 3.7c.3.2.6.1.8-.1l.7-.6c.2-.1.4-.2.7-.1l2.1.9c.5.2.5.5.5.8 0 .6-.2 1.2-.5 1.5-.4.5-1.1.9-1.9.9-1.7 0-3.7-1-5.3-2.6S7 13 7 11.3c0-.8.4-1.5.9-1.9.3-.3.9-.5 1.5-.5z" fill="currentColor" stroke="none" />
        </svg>
      );
    default:
      return null;
